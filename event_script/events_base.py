...
class EventsBase:
    ...
    def __init__(self, ignore_class: list = None, logger=None, setting=None, queue=None):
        if ignore_class:
    ...
    def get_child_class(self) -> list:
        ...
        :return:
        """
        return [cls_name(self.logger, self.setting, self.queue) for cls_name in self.__get_chile_class() if
